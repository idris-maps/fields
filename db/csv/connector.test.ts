...
Deno.test("[csv connector] db should have expected keys", () => {
  hasExpectedKeys(
    [
      "initTable",
      "createTable",
...
Deno.test("[csv connector] create and init table", async () => {
...
Deno.test("[csv connector] db.initTable", async () => {
...
Deno.test("[csv connector] table.insert", async () => {
...
Deno.test("[csv connector] table.getById", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
  const inserted = await table.insert(data);
...
Deno.test("[csv connector] table.get", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
...
Deno.test("[csv connector] table.get eq", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
...
Deno.test("[csv connector] table.get in / notIn", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
  const one = await table.insert(data);
  const two = await table.insert({ ...data, num: 2 });
...
Deno.test("[csv connector] table.get like / notLike", async () => {
  const LIKE = "like";
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
...
Deno.test("[csv connector] table.get lt / lte / gt / gte", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
...
Deno.test("[csv connector] table.get sort", async () => {
  const table = await getTable();
...
Deno.test("[csv connector] table.remove", async () => {
  const table = await getTable();
  const data = { todo: "todo", done: false, num: 1 };
  const { __id } = await table.insert(data);
